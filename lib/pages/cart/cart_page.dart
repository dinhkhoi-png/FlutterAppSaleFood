...
import 'package:flutter_app_sale/base/no_data_page.dart';
      ...
      body: Stack(
        children: [
          ...
          GetBuilder<CartController>(builder: (_cartController){
                                    ...
                                    onTap: (){
                                      ...
                                      if(popularIndex >= 0){
                                        ...
                                        if(recommendedIndex < 0){
                                          Get.snackbar("History Product","Product review is not valible for history product",
                                            backgroundColor: AppColors.mainColor,
            ...
            ):NoDataPage(text: "Your Cart isempty !");
          }),
        ],
      ),
